...
if submitted_threshold:
    ...
    if st.session_state.get('threshold') != threshold \
            or st.session_state.get('min_days') != min_days:
...
if submitted_slope:
    ...
    if st.session_state.get('slope_points') != slope_points:
...
if st.session_state.get("submitted_threshold"):
    st.session_state.classified_mutations_threshold = \
        classify_mutations_threshold(st.session_state.smoothed_data_files_sequences, threshold, min_days)
