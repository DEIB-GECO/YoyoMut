...
with reports_threshold:
    ...
    with st.form("parameters-threshold", enter_to_submit=False):
        ...
        submitted_threshold = st.form_submit_button("Submit", on_click=submit_threshold_form,
    ...
    if 'fixated_threshold_report_path' in st.session_state:
        ...
        with thr_rep_col2:
            st.download_button(
                label="Download fixated mutations report",
